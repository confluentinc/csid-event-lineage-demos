...
public class JsonTransactionSerde implements Serializer<Transaction>, Deserializer<Transaction>, Serde<Transaction> {
    ...
    @Override
    public Transaction deserialize(final String topic, final byte[] data) {
        if (data == null) {
            return null;
        }

        try {
            return OBJECT_MAPPER.readValue(data, Transaction.class);
