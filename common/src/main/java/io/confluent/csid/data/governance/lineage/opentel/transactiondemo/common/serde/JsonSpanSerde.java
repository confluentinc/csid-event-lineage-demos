...
public class JsonSpanSerde implements Serializer<Span>,
    Deserializer<Span>, Serde<Span> {
    ...
    @Override
    public Span deserialize(final String topic, final byte[] data) {
        if (data == null) {
            return null;
        }

        try {
            return OBJECT_MAPPER.readValue(data, Span.class);
    ...
    @Override
    public byte[] serialize(final String topic, final Span data) {
        if (data == null) {
            return null;
        }
